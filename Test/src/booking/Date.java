...
public class Date {
    ...
    /**
     * Three field variables for day, month, and year of types int, String and
     * int, respectively.
     */
    private int day;
     ...
     * @return true if the day, the month, and the year are all admissible THIS
     * IS A METHOD STUB. THE METHOD NEEDS STILL TO BE WRITTEN!
     */
